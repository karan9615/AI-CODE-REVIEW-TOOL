...
An automated GitLab Merge Request creation and review tool powered by AI (ChatGPT & Gemini).

## ✨ Features

### Backend
- ✅ **Comprehensive MR Change Detection**
  - Handles new files, deleted files, renamed files, and modified files
  - Proper `old_path` and `new_path` mapping for GitLab API
  - Supports inline comments on all change types

- ✅ **AI-Powered Review**
  - ChatGPT (GPT-4) integration
  - Google Gemini integration
  - Generates meaningful MR titles and descriptions
  - Creates inline code review comments
...
- ✅ **Production-Ready Backend**
  ...
  - Graceful error recovery for failed comments

### Frontend
- ✅ **Modern GitLab-Inspired UI**
  - Official GitLab color scheme (#6b4fbb purple theme)
  - Professional card-based layout
  - Responsive design

- ✅ **Excellent UX**
  - Real-time loading states with spinners
  - Progress indicators for MR creation steps
  - Success/error notifications with detailed messages
  - Direct links to created MRs
